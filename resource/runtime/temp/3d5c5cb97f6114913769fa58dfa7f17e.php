<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\admin\lst.htm";i:1494048885;s:86:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\common\top.htm";i:1493170150;s:87:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\common\left.htm";i:1493552985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<!--Basic Styles-->
<link href="/ziyuanku/public/static/admin
...
<li>
  ...
  <li>
    ...
    <div class="page-content"> 
      ...
      <!-- Page Body -->
      <div class="page-body">
        <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/add'); ?>'"> <i class="fa fa-plus"></i> Add </button>
        <div class="row">
                ...
                <div class="flip-scroll">
                  <table class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td align="center"><a href="<?php echo url('admin/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny"> <i class="fa fa-edit"></i> 编辑 </a> <?php if($vo['id'] != 1): ?> <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny"> <i class="fa fa-trash-o"></i> 删除 </a> <?php endif; ?> </td>
                    </tr>
