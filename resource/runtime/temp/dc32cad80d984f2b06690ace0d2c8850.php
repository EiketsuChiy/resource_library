<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\computerapp\add.html";i:1494298882;s:92:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\common\top.html";i:1493170150;s:93:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\common\left.html";i:1494202963;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
      ...
      <div class="page-body">
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
              <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">新增资源</span> </div>
                ...
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input id="file" placeholder="" name="file"  type="file">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input id="video" placeholder="" name="video"  type="file">
                      </div>
                    </div>
