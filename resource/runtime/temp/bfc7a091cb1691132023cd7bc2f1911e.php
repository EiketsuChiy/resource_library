<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\computerapp\index.html";i:1494470760;s:92:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\common\top.html";i:1493170150;s:93:"D:\ProgramFiles\UPUPW_NP7.0\htdocs\resource\public/../application/admin\view\common\left.html";i:1494202963;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                ...
                <div class="flip-scroll">
                  <table class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td align="center"> <?php if($vo['file'] != ''): ?><a href="/resource/public/static<?php echo $vo['file']; ?>"><?php echo substr($vo['file'],14,50); ?></a><?php else: ?>
                        暂无文档
                        <?php endif; ?> </td>
                      <td align="center"> <?php if($vo['pic'] != ''): ?> <img src="/resource/public/static<?php echo $vo['pic']; ?>" height="50"> <?php else: ?>
                        暂无图片
                        <?php endif; ?> </td>
                        <td align="center"> <?php if($vo['video'] != ''): ?> <a href="/resource/public/static<?php echo $vo['video']; ?>"><?php echo substr($vo['video'],15,50); ?></a><?php else: ?>
                        暂无视频
                        <?php endif; ?> </td>
                      <td align="center">
