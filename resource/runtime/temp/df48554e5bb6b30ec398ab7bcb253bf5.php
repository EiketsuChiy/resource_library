<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\computerapp\detail.html";i:1494313780;s:87:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\common\top.html";i:1493170150;s:88:"H:\wangzhanshixun\AppServ\www\resource\public/../application/admin\view\common\left.html";i:1494202963;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
      ...
      <center>
        ...
        <div class="row">
          <div class="col-lg-12 col-sm-12 col-xs-12">
            <div class="widget">
              <div class="widget-header bordered-bottom bordered-blue"> <span class="widget-caption">资源详情</span><h2><input type="button" name="fh" id="fh" value=""  onclick="history.back();" style="cursor:pointer;background:url(/resource/public/static/admin/images/fanhui.png);width:32px;height:32px; border:none; " title="返回"/>&nbsp;&nbsp;&nbsp;</h2></div>
              <div class="widget-body">
                <div id="horizontal-form">
                  <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                    <input type="hidden" name="id" value="<?php echo $Computerapps['id']; ?>">
                    <div >
                      <div><h3>标题:</h3><?php echo $Computerapps['title']; ?> </div>
                      <hr>
                      <div><h3>内容:</h3><?php echo $Computerapps['content']; ?>  </div>
                      <hr>
                      <div><h3>文档:</h3><a href="/resource/public/static<?php echo $Computerapps['file']; ?>"><?php echo substr(strtolower($Computerapps['file']),23); ?></a>
                      </div>
                        <hr>
                      <div><h3>图片:<br><br><img src="/resource/public/static<?php echo $Computerapps['pic']; ?>"</h3></div>
                      <hr>
                      <div><h3>视频:</h3><video src="/resource/public/static<?php echo $Computerapps['video']; ?>" controls="controls"></video></div>
                      </div>
                    </div>
                  </form>
                </div>
